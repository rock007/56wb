...
<div id="main">
	<div id="toolbar">
		<shiro:hasPermission name="Sys:session:forceout"><a class="waves-effect waves-button" href="javascript:;" onclick="forceoutAction()"><i class="zmdi zmdi-run"></i> 强制退出</a></shiro:hasPermission>
	</div>
